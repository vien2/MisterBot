...
nombre_archivo = f"predicciones_jornada_{jornada_a_predecir}.csv"
columnas_exportar = ['jornada', 'equipo_local', 'equipo_visitante', 'prediccion_1x2', 'confianza']

df_pred_jornada[ columnas_exportar ].to_csv(nombre_archivo, index=False, encoding='utf-8-sig')
