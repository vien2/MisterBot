...
def insertar_datos_mercado(temporada_actual, datos_mercado):
    ...
    try:
        ...
        print(f"Datos del Mercado insertados/actualizados correctamente en la coleccion {coleccion.name}.")
