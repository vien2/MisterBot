...
def insertar_datos_clasificacion_general(temporada_actual,datos_usuarios):
    ...
    try:
        for coleccion_nombre in colecciones:
            if coleccion_nombre == 'Clasificacion_General':
        ...
        print(f"Datos de Clasificación general insertados/actualizados correctamente en la coleccion {coleccion.name}.")
