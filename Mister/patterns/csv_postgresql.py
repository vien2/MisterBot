            ...
            with conn.cursor() as cur:
                ...
                if tipo_carga == "total":
                    ...
                    if resultado:
                        ...
                        log(f"Carga incremental: registros nuevos con {incremental_field} > {valor_incremental}")
                    else:
                    ...
                    df = df[df["__clave__"].apply(lambda k: k not in registros_db or registros_db[k] != df.loc[df["__clave__"] == k, hash_field].values[0])]
