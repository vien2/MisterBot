...
from Jugadores.obtener_datos_jugador import obtener_datos_jugador,obtener_registros_transferencia,obtener_puntos,obtener_valores,obtener_datos_jornadas 
